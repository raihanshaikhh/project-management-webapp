  ...
  return (
    ...
    >
          ...
          <motion.div initial={{ scale: 0.8, opacity: 0 }}
            ...
            transition={{ type: "spring", stiffness: 300, damping: 25 }} className="relative w-full max-w-110 mx-4 max-h-[85vh] overflow-y-auto rounded-2xl border border-zinc-800 shadow-2xl custom-scrollbar"
